...
image_icon = PhotoImage(file="music-player.png")
root.iconphoto(False, image_icon)

frameCnt = 30
frames = [
    PhotoImage(file='aa1.gif', format='gif -index %i' % (i))
...
Buttonvolume = PhotoImage(file="volume-up.png")
Button(root,
       image=Buttonvolume,
       bg="#FFFFFF",
       bd=0,
...
ButtonPause = PhotoImage(file="pause-button.png")
Button(root,
       image=ButtonPause,
       bg="#FFFFFF",
       bd=0,
